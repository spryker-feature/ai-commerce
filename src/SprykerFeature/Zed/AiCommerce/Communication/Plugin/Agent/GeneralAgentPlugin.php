...
use Generated\Shared\Transfer\GeneralAgentResponseTransfer;
...
class GeneralAgentPlugin extends AbstractPlugin implements BackofficeAssistantAgentPluginInterface
{
    ...
    protected const string NAME = 'General';
    ...
    public function executeAgent(
        ...
        if (!$promptResponse->getIsSuccessful()) {
            $this->getLogger()->error(sprintf(
                'GeneralAgent prompt response is not successful: %s',
        ...
        /** @var \Generated\Shared\Transfer\GeneralAgentResponseTransfer $generalPurposeAgentResponse */
