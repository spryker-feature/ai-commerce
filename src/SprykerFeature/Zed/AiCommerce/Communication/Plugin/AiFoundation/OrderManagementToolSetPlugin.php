...
class OrderManagementToolSetPlugin extends AbstractPlugin implements ToolSetPluginInterface
{
    ...
    {
        return static::TOOL_SET_ORDER_MANAGEMENT;
    }

    /**
     * {@inheritDoc}
     * - Returns order management tool plugins including knowledge base skill, OMS transitions, manual events, and state flags tools.
     *
     * @api
     *
    ...
    {
        return [
            $this->getFactory()->createSkillOrderManagementKnowledgeBaseToolPlugin(),
