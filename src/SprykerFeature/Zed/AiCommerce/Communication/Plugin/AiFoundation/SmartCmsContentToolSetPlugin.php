 ...
 */
class SmartCmsContentToolSetPlugin extends AbstractPlugin implements ToolSetPluginInterface
{
    protected const string TOOL_SET_SMART_CMS_CONTENT = 'smart_cms_content_tools';
    ...
    {
        return static::TOOL_SET_SMART_CMS_CONTENT;
    }

    /**
     * {@inheritDoc}
     * - Returns the tools available to the Smart CMS feature, including existing content item lookup.
     *
     * @api
     *
    ...
    {
        return [
            $this->getFactory()->createGetContentItemsToolPlugin(),
        ];
    }
}
