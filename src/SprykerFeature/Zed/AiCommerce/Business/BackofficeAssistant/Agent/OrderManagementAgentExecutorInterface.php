...
interface OrderManagementAgentExecutorInterface
{
    /**
     * @api
     */
    public function execute(BackofficeAssistantPromptRequestTransfer $promptRequestTransfer): BackofficeAssistantPromptResponseTransfer;
}
