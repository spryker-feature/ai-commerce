...
class BackofficeAssistantConversationUpdater implements BackofficeAssistantConversationUpdaterInterface
{
    ...
    public function updateCollection(
        ...
        foreach ($collectionRequestTransfer->getBackofficeAssistantConversations() as $conversationTransfer) {
            $this->entityManager->updateBackofficeAssistantConversation($conversationTransfer);

            $responseTransfer->addBackofficeAssistantConversation($conversationTransfer);
        }
