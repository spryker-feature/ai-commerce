...
class OrderManagementToolPluginsTest extends Unit
{
    ...
    public function testGetOrderDetailsToolPluginReturnsJsonWithOrderData(): void
    {
        ...
        $this->assertArrayNotHasKey('billingAddress', $decoded);
        $this->assertArrayNotHasKey('shippingAddress', $decoded);
        $this->assertArrayNotHasKey('billingAddress', $decoded['items'][0]);
        $this->assertArrayNotHasKey('shippingAddress', $decoded['items'][0]);
    }
